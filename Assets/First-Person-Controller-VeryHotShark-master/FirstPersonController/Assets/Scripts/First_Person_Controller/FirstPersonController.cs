...
namespace VHS
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        #region Smooth Settings
                    [Space]
                    [BoxGroup("Smooth Settings")] public bool useSmooth = false;
        ...
        #region Custom Methods
            ...
            #region Smoothing Methods
                void SmoothInput()
                {
                    ...
                    if (useSmooth)
                        ...
                        m_smoothInputVector = m_inputVector;
                ...
                void SmoothSpeed()
                {
                    if (useSmooth)
                        ...
                        m_smoothCurrentSpeed = m_currentSpeed;
                ...
                void SmoothDir()
                {
                    if (useSmooth)
                        ...
                        m_smoothFinalMoveDir = m_finalMoveDir;
            ...
            #region Locomotion Apply Methods
                ...
                void HandleHeadBob()
                {
                    ...
                    m_yawTransform.localPosition = new Vector3(m_camTransform.localPosition.x, m_yawTransform.localPosition.y, m_yawTransform.localPosition.z);
